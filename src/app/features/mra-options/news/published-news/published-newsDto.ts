...
export const searchPublishedNewsConfig = [
    ...
    { name: 'fromDate', label: 'From Date(Source)', type: 'calendar', placeholder: 'Select' },
    { name: 'toDate', label: 'To Date(Source)', type: 'calendar', placeholder: 'Select' },
    { name: 'fromDate', label: 'From Date(Published)', type: 'calendar', placeholder: 'Select' },
    { name: 'toDate', label: 'To Date(Published)', type: 'calendar', placeholder: 'Select' }
  ];
